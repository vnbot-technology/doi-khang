...
func _do_special() -> void:
	...
	velocity.x += (1.0 if facing_right else -1.0) * 480.0
			attack_hitbox.damage = 26.0; attack_hitbox.knockback_force = 360.0
...
func _do_ultimate() -> void:
	...
	velocity.x += (1.0 if facing_right else -1.0) * 380.0
			attack_hitbox.damage = 50.0; attack_hitbox.knockback_force = 520.0
